package com.learnautomation.ex03_Selenium_Locators;
...
public class TestSelenium17_Project {
    @Owner("Vikrant")
    @Severity(SeverityLevel.BLOCKER)
    @TmsLink("https://bugz.atlassian.net/browse/BUG-17")
    @Test(description = "Verify that the error message comes with invalid email on signup page.")
